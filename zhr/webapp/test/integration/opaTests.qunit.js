...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/jhah/hr/zhr/test/integration/FirstJourney",
    "com/jhah/hr/zhr/test/integration/VarListListJourney",
    "com/jhah/hr/zhr/test/integration/VarListObjectPageJourney",
    "com/jhah/hr/zhr/test/integration/VisitorDetailsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
